  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        glow:
          "bg-primary text-primary-foreground hover:bg-primary/90 shadow-[0_0_20px_hsl(185_95%_55%/0.4)] hover:shadow-[0_0_30px_hsl(185_95%_55%/0.6)] transition-shadow",
        gradient:
          "bg-gradient-to-r from-primary to-accent text-primary-foreground hover:opacity-90 shadow-lg",
        glass:
          "bg-card/50 backdrop-blur-md border border-border/50 hover:bg-card/70 hover:border-primary/30",
      },
      size: {
